    ...
    if (
      ...
      if (I = I / g + 2 | 0, a = 0, T == 1) {
        ...
        for (
          d = l / (k[0] + 1) | 0,
            d > 1 &&
            (k = e(k, d, l), R = e(R, d, l), T = k.length, W = R.length),
            z = T,
            E = R.slice(0, T),
            P = E.length;
          P < T;
        ...
        do d = 0,
          ...
          f < 0
            ...
            : f === 0 && (d++, E = [0]),
          q[a++] = d,
          f && E[0] ? E[P++] = R[z] || 0 : (E = [R[z]], P = 1); while (
          (z++ < W || E[0] !== void 0) && I--
        );
        v = E[0] !== void 0;
      }
  ...
  e: if (n != null) {
      ...
      t = t || n < 0 || a[d + 1] !== void 0 ||
        ...
        f = i < 4 ? (l || t) && (i == 0 || i == (e.s < 0 ? 3 : 2)) : l > 5 ||
          l == 5 &&
            (i == 4 || t ||
              i == 6 &&
                (s > 0 ? o > 0 ? c / C(10, r - o) : 0 : a[d - 1]) % 10 & 1 ||
              i == (e.s < 0 ? 8 : 7)),
        n < 1 || !a[0]
    ) {
      return a.length = 0,
    ...
    if (
      s == 0
        ...
        : (a.length = d + 1,
          u = C(10, m - s),
          a[d] = o > 0 ? (c / C(10, r - o) % C(10, o) | 0) * u : 0), f
    ) {
      for (;;) {
        if (d == 0) {
...
function Ue(e, n, i, t) {
  ...
  for (w = !1;;) {
    if (
      i % 2 && (s = s.times(n), _e(s.d, o) && (r = !0)), i = b(i / 2), i === 0
    ) {
...
function B(e, n) {
  ...
  } else {return f = se(M, c + 2, E).times(s + ""),
